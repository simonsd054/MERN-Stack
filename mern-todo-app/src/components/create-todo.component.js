...
export default class CreateTodo extends Component{
    ...
    constructor(props){
        ...
        this.onChangeTodoResponsble = this.onChangeTodoResponsble.bind(this);
    ...
    onSubmit(e){
        ...
        const newTodo = {
            ...
            todo_responsible: this.state.todo_resposible,
            ...
            <div style={{marginTop: 20}}>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" 
                        value={this.state.todo_resposible} onChange={this.onChangeTodoResponsble}>
                        </input>
                    </div>
                    <div className="form-group">
